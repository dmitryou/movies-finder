...
export default function FooterOne() {
    return (
        <footer className="footer-area pt-40">
            <div className="container">
                <div
                    className="row footer-bottom row-gap-3"
                    style={{
                        display: "flex",
                ...
                >
                    <div
                        className="col-sm-6 text-sm-start order-4 order-sm-0"
                        style={{
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                    ...
                    >
                        ...
                        >
                            <li className="social-media--item">
                                ...
                                <Link
                                    href="https://www.instagram.com/i_like_to_cook_food/"
